...
public class login1 implements Initializable{
    ...
    public static String id_admin_data;
    public static String email_admin_data;
    ...
    @FXML
    public void loginAdminAction(ActionEvent e)throws IOException{
        ...
        pt.setOnFinished(ev ->{
            ...
            try {
                ...
                ResultSet st = conn.createStatement().executeQuery("SELECT * FROM admin where email = '" + email1.getText() + "'and password ='" + String.valueOf(pass.getText()) + "'");
//                ResultSet st = conn.createStatement().executeQuery("SELECT * FROM admin where username = 'danzai'and password ='123'");

                if (st.next()) {
                    id_admin_data = st.getString("id_admin");
                    email_admin_data = st.getString("email");
                    ...
                    if (email_admin_data.equals("admin@gmail.com")) {
                        ...
                        loader.setLocation(getClass().getResource("/View/login_1.fxml"));
